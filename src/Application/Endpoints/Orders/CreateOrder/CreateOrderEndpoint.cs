...
public sealed class CreateOrderEndpoint : Endpoint<Request, Response, OrderMapper>
{
    private readonly ApplicationDbContext _context;
    private readonly IOrderRepository _orderRepository;

    public CreateOrderEndpoint(ApplicationDbContext context, IOrderRepository orderRepository)
    {
        _context = context;
